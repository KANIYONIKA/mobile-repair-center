	...
	return (
		<>
			...
			<div className="relative hidden h-[525px] w-full overflow-hidden xl:block">
				<img
					src={props.homeTitleDesktopImgSrc}
					alt="モバイル修理センター"
					className=" absolute left-1/2 h-[525px] min-w-[1920px] max-w-screen-lg -translate-x-1/2 transform"
				/>

				{/* 文字を表示する部分 */}
					<div className="font-wight-400 absolute left-1/2 top-[370px] flex translate-x-[260px] transform text-sm text-primary-text1 ">
						<img
							src="/img/icon-concierge.svg"
							alt="買取や修理のサポートが必要ですか？"
			...
			<div className="relative hidden h-auto w-full md:block xl:hidden">
				<img
					src={props.homeTitleTabletImgSrc}
					alt="モバイル修理センター"
