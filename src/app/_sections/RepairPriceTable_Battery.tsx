                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className={css_tbody_tr_td_2}>12,500円</td>
                                <td className={css_tbody_tr_td_2}>17,000円</td>
                            </tr>
                            <tr>
                                <td className={css_tbody_tr_td_1}>
                                ...
                                <td className={css_tbody_tr_td_2}>10,500円</td>
                                <td className={css_tbody_tr_td_2}>14,000円</td>
                            </tr>
                            <tr>
                                <td className={css_tbody_tr_td_1}>
                                ...
                                <td className={css_tbody_tr_td_2}>12,000円</td>
                            </tr>
                            <tr>
                                <td className={css_tbody_tr_td_1}>
                                ...
                                <td className={css_tbody_tr_td_2}>10,000円</td>
                            </tr>
                            <tr>
                                <td className={css_tbody_tr_td_1}>
