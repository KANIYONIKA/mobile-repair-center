...
import { SectionTitle_PrivacyPolicy } from "../_components/SectionTitles";
                ...
                <main className="">
                    <FadeIn>
                        <ResponsiveSectionContainer>
                            <PageTitle literal="プライバシーポリシー" />
                        </ResponsiveSectionContainer>

                        <ResponsiveSectionContainer>
                            <SectionTitle_PrivacyPolicy />
                            <div className="text-primary-text2">
                                <div className="mb-10">
                                    株式会社リングライズ（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
                                </div>
                                ...
                                <div className="">
                                    住所：{COMPANY_INFORMATION_LingRise.postCode} {COMPANY_INFORMATION_LingRise.address}
                                </div>
                                <div className="">社名：{COMPANY_INFORMATION_LingRise.japaneseName}</div>
                                <div className="">電話番号：{COMPANY_INFORMATION_LingRise.tel}</div>
                            </div>
                        </ResponsiveSectionContainer>
                    </FadeIn>
                </main>
